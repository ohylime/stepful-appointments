  ...
  return (<>    
    ...
    <div className='h-full grid grid-cols-4 m-5 gap-4'>
      ...
      <div className='m-5 h-1/2 flex flex-col justify-evenly' >
          <AppointmentForm id={params.id} isOpen={isApptFormOpen} close={()=> {setApptForm(false)}}/>
          <Button size='sm' className='bg-[#C38774]' onPress={()=>setApptForm(true)}> Add Appointment</Button>
          <Button size='sm' className='bg-[#C38774]'> Feedbacks</Button>
      </div>
